...
- IEEE - Institute of Electrical and Electronics Engineers: C57, C37, C62, 1547, 1584 arc-flash, 2030, 2800, 3000, and 80/81/837 grounding metadata ingestion started from official IEEE SA pages.
